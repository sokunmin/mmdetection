...
class TTFHead(BaseDenseHead):
    ...
    def __init__(self,
        ...
        self.hm = self.build_head(self.num_classes, hm_head_conv_num)
    ...
    def forward(self, feats):
        ...
        hm = self.hm(x)  # > (#cls, 128, 128)
        # > TOCHECK `wh_offset_base`: https://github.com/ZJULearning/ttfnet/issues/17
        wh = F.relu(self.wh(x)) * self.wh_offset_base  # > (4, 128, 128)
